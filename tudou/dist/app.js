...
/***/ function(module, exports, __webpack_require__) {
	...
	var less = __webpack_require__(3); 
	var startGame = __webpack_require__(28);
	var mapPage   = __webpack_require__(30);
	var shPage       = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $            = __webpack_require__(1);
	var stagePage    = __webpack_require__(29)
...
/***/ function(module, exports, __webpack_require__) {
	...
	Map.prototype = {
		...
		submitDataForBaby:function(){
			var name  = self.babyPop02.find('.name').trim();
			var phone = self.babyPop02.find('.phone').tirm();
			var address = self.babyPop02.find('.address').tirm();
			var type    = 3;
			var param   = {
				name:name,
				phone:phone,
		...
		submitDataForBag:function(){
			var self = this;
			var name  = self.bagPop02.find('.name').trim();
			var phone = self.bagPop02.find('.phone').tirm();
			var address = self.bagPop02.find('.address').tirm();
			var type    = 2;
			var param   = {
				name:name,
				phone:phone,
			...
			if(!debug){
				$.ajax({
					...
					data:param,
					succes:function(){
						console.log('bagPop02 submit all right.');
					}
				});
			}
		},
	...
	Stage.prototype = {
		...
		getPhData:function(){
			...
			if(debug){
				data = [
					{srcName:'one.jpg',name:'渡头',totalScore:98800},
					{srcName:'two.jpg',name:'水平',totalScore:92300},
					{srcName:'three.jpg',name:'狗仔队',totalScore:51800},
					{srcName:'four.jpg',name:'那样有',totalScore:46700},
					{srcName:'five.jpg',name:'墨阳の',totalScore:18200}
				];
				self.buildph(data);
			}else{
				$.ajax({
		...
		buildph:function(data){
			...
			for(var i=0,len=data.length; i<len; i++){
				var itemStr = '<li>'
					'<label class="turn">'+ i>=4?i:'' +
					'</label>'+
					'<img src="./images/icon/'+ data[i].srcName +'"  class="icon"/>'+
